        ...
        Column(
            ...
            Button(
                onClick = {
                    ...
                    val isValidEmail = validateName(inputEmail).first
                    val isValidPassword = validateName(inputPassword).first
                    ...
                    emailError = validateName(inputEmail).second
                    passwordError = validateName(inputPassword).second
                    passwordConfirmationError = validateName(inputPasswordConfirmation).second
